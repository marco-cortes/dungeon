...
public class Duende extends Movimiento
{
    ...
    {
        animacionCamina.add(new Animacion(Assets.duendeCamina, velocidadA, x, y));
        animacionCaminaI.add(new Animacion(Assets.duendeCaminaI, velocidadA, x, y));
        animacionEstatico.add(new Animacion(Assets.duendeEstatico, velocidadA, x, y));
        animacionEstaticoI.add(new Animacion(Assets.duendeEstaticoI, velocidadA, x, y));
        animacionMuere.add(new Animacion(Assets.duendeMuere, velocidadA, x , y));
        animacionMuereI.add(new Animacion(Assets.duendeMuereI, velocidadA, x , y));
        animacionAtaca.add(new Animacion(Assets.duendeCamina, velocidadA, x ,y));
        animacionAtacaI.add(new Animacion(Assets.duendeCaminaI, velocidadA, x, y));
    }
    @Override
